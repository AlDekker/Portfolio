...
$title = $subject ? $subject : 'Message from iSecurity';
$body = '
<!--[if (gte mso 9)|(IE)]>
...
try {
  ...
  $mail->Host       = 'smtp.yandex.ru'; // SMTP сервера вашей почты (smtp.mail.ru для Mail.ru)
  $mail->Username   = ''; // Логин на почте
  $mail->Password   = ''; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;
  $mail->setFrom('', 'iSecurity'); // Адрес самой почты и имя отправителя
